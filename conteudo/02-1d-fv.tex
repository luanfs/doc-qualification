...
This approach has been further investigated in the literature (c.f, e.g. . \citep{lin:1996,leonard:1996}).
...
\begin{figure}[!htb]
	...
	\caption{Illustration of $\Delta x$-grid function $Q$ and $u$ and its ghost cell
		values (in red) assuming periodicity.\label{chp2-sec1-grid1d-function}}
\end{figure}
...
overshoots, with PPM-L04 \citep{lin:2004} being more accurate than the scheme proposed by 
\citep{colella:1984}.
