...
\end{align*}
We use the notation $\mathbb{R}^{N}_{\nu,P}$ and $\mathbb{R}^{N+1}_{\nu,P}$ to
...
Given $Q \in \mathbb{R}^{N}_{\nu,P}$, we define the $p$-norm as
\begin{equation}
	\label{chp2-sec-not1}
	\|Q\|_{p,\Delta x}=
	\begin{cases}
...
\begin{prob}[1D FV-SL scheme]
	...
	\begin{equation}
		...
		\quad \forall n = 0, \ldots, N_T-1,
	\end{equation}
	where ${Q}^{n} \in \mathbb{R}^{N}_{\nu,P}$ is intended to be an approximation
	of ${Q}(t^{n})\in \mathbb{R}^{N}_{\nu,P}$ in some sense. We define
...
In this context, it is convenient to define the $\Delta x$-grid function $Q\in \mathbb{R}^{N}_{\nu,P}$ with the entries given by $Q_i$.
...
Assuming that $Q^{n} \in \mathbb{R}^{N}_{\nu,P}$ is known, our objective is to compute the values $Q^{n+1}$.
