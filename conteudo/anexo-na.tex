...
\subsection{Convergence, consistency and stability of 2D-FV schemes}
\label{chp3-CCS}
...
$\mathcal{H}_{\Delta x ,\Delta y,n}: \mathbb{R}^{N \times N} \to \mathbb{R}^{N \times M}$ whose $(i,j)$ entry is given by:
\begin{align*}
