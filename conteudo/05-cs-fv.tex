...
\begin{align}
	...
	\end{cases}
\end{align}
for $i=1, \ldots, N$, $j=1, \ldots, M$, $p=1,\ldots,6$. Then, we integrate the parabolas and obtain
\begin{align}
	\label{chp5-flux-xdir--pl07}
	F_{i+\frac{1}{2},j,p}^n ({Q^n_{\times,j,p},\tilde{u}^n_{i+\frac{1}{2},j,p}}) &={\sigma}_{i+\frac{1}{2},j,p} \tilde{u}^{n}_{i+\frac{1}{2},j,p}\\
	&\times
	\begin{cases}
