...
\begin{figure}[!htb]
	...
	\begin{subfigure}{0.42\textwidth}
		\centering
		\includegraphics[width=1\linewidth]{cs_div_vf2_normlinf_parabola_errors}
		\caption{Error.\label{chp5-errordiv}}
	\end{subfigure}
	\begin{subfigure}{0.42\textwidth}
		\centering
		\includegraphics[width=1\linewidth]{cs_div_vf2_normlinf_convergence_rate}
...
\begin{figure}[!htb]
	...
	\begin{subfigure}{0.3\textwidth}
		\centering
		\includegraphics[width=1\linewidth]{gnomonic_equiangular_cs_512_div_error_vf2_SP-PL07_PPM-PL07_RK1_ET-PL07_MT-PL07_sphere}
		\caption{Scheme 1 \label{chp5-div1}}
	\end{subfigure}
	\begin{subfigure}{0.3\textwidth}
	\centering
	\includegraphics[width=1\linewidth]{gnomonic_equiangular_cs_512_div_error_vf2_SP-AVLT_PPM-PL07_RK2_ET-ZA22-AF_MT-0_sphere}
	\caption{Scheme 3 \label{chp5-div2}}
	\end{subfigure}
	\begin{subfigure}{0.3\textwidth}
	\centering
	\includegraphics[width=1\linewidth]{gnomonic_equiangular_cs_512_div_error_vf2_SP-AVLT_PPM-PL07_RK2_ET-ZA22-PR_MT-0_sphere}
...
\begin{figure}[!htb]
	...
	\begin{subfigure}{0.42\textwidth}
		\centering
		\includegraphics[width=1\linewidth]{cs_adv_tc2_ic2_vf2_normlinf_parabola_errors}
		\caption{Error.\label{chp5-adv1-error}}
	\end{subfigure}
	\begin{subfigure}{0.42\textwidth}
		\centering
		\includegraphics[width=1\linewidth]{cs_adv_tc2_ic2_vf2_normlinf_convergence_rate}
...
\begin{figure}[!htb]
	...
	\begin{subfigure}{0.42\textwidth}
		\centering
		\includegraphics[width=1\linewidth]{cs_adv_tc2_ic4_vf2_normlinf_parabola_errors}
		\caption{Error.\label{chp5-adv2-error}}
	\end{subfigure}
	\begin{subfigure}{0.42\textwidth}
		\centering
		\includegraphics[width=1\linewidth]{cs_adv_tc2_ic4_vf2_normlinf_convergence_rate}
